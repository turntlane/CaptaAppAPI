...
export declare class FocusAidController {
    private readonly focusAidService;
    constructor(focusAidService: FocusAidService);
    ...
    updateSession(sessionId: string, updateDto: Partial<CreateFocusAidSessionDto>): Promise<{
        sessionId: string;
        difficultyLevel: number | null;
        preSessionInfo: import("@prisma/client/runtime/library").JsonValue | null;
        postSessionFeedback: import("@prisma/client/runtime/library").JsonValue | null;
    ...
    getAttentionScores(sessionId: string, startTime?: string, endTime?: string): Promise<{
        id: bigint;
        sessionId: string;
        timestamp: bigint;
        attentionScore: import("@prisma/client/runtime/library").Decimal;
