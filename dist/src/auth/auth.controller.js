...
const refresh_dto_1 = require("../common/dto/refresh.dto");
const metadata_decorator_1 = require("../common/decorators/metadata.decorator");
const login_rate_limit_interceptor_1 = require("../common/interceptors/login-rate-limit.interceptor");
let AuthController = class AuthController {
    ...
    async refresh(refreshDto, metadata) {
...
__decorate([
    ...
    __param(1, (0, metadata_decorator_1.Metadata)()),
...
__decorate([
    ...
    (0, common_1.UseInterceptors)(login_rate_limit_interceptor_1.LoginRateLimitInterceptor),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, metadata_decorator_1.Metadata)()),
    __metadata("design:type", Function),
